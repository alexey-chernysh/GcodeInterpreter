...
public class LineParser extends CNCCommandSequence {
	...
	public void evalute(RoutineParser cncSubProgram) throws GcodeRuntimeException{
		...
		for(i=0; i<size; i++){
			...
			case G:
				...
				case 580:
					...
					break;
				case 590:
					evalutionSequenciveBlock.setFixtureToolOffset(LineEvolutionSequence.G59_SELECTED);
					break;
				case 610:
